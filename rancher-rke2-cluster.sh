...
master2=192.168.1.112
master3=192.168.1.113
master4=192.168.1.114
master5=192.168.1.115
...
# Array of all
all=($master1 $master2 $master3 $master4 $master5)

# Array of all minus master1
allnomaster1=($master2 $master3 $master4 $master5)

#Loadbalancer IP range
lbrange=192.168.2.10-192.168.2.50
